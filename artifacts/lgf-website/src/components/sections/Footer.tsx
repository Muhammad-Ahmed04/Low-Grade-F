...
export default function Footer() {
  return (
    <footer className="bg-black py-10" style={{ borderTop: "1px solid rgba(192,192,192,0.2)" }}>
      <div className="container mx-auto px-6 lg:px-16">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="text-gray-500 text-xs tracking-widest uppercase text-center order-3 md:order-2">
